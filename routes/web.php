...
Route::POST('/addTocart', [TransaksiController::class, 'addTocart'])->name('addTocart')->middleware('auth');
...
Route::delete('checkout/{id}', [Controller::class, 'destroyCart'])->name('checkout.destroy');
